export default class Products {
    ...
    render() {
        ...
        linkBlock.setAttribute("contenteditable", true);
        linkBlock.setAttribute("data-placeholder", "Ссылка на товар");
        linkBlock.classList.add("product-property__link");

        wrapper.appendChild(linkBlock);

        linkBlock.textContent = this.data.link;
    ...
    save(blockContent) {
        const link = blockContent.querySelector(".product-property__link");
